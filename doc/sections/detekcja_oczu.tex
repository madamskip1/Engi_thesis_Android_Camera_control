...
Wykorzystywany jest tu też wskaźnik \textit{EAR} (patrz rozdz.~\hyperref[{section:EARsection}]{\textit{\ref{section:EARsection}}}) do wykrycia czy oko jest zamknięte czy otwarte.
