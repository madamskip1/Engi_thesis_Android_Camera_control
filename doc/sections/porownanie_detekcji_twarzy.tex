...
\input{tables/face_detection_accuracy_rgb}
\input{tables/face_detection_accuracy_gray}
...
\input{tables/face_detection_speed_rgb}
\input{tables/face_detection_speed_gray}
...
\input{tables/face_detection_accuracy_live}
...
\input{tables/face_detection_speed_live}
